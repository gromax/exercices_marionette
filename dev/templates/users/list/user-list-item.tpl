...
<td><%- nom %> <%- prenom %></td>
<td><a href="mailto:<%- email %>"><i class="fa fa-envelope" aria-hidden="true"></i></a></td>
<td><%- nomClasse %></td>
<td><%- date %></td> <!-- à parser -->
<td><%- rank %></td>
<td align="right">
	<div class="btn-group" role="group">
		...
		<!-- Bouton notes - pour les élèves -->
		<a href="#notes-eleve:<%- id %>" class="btn btn-primary btn-sm" role="button"><i class="fa fa-th-list" aria-hidden="true" title="Voir les notes"></i></a>
	</div>
</td>
