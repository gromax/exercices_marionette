  ...
  return {
    ...
    geometrie: {
      analytique: {
        ...
        plg: ["Pour que &nbsp; $ABCD$ soit un parallélogramme, il faut que &nbsp; $[AC]$ et &nbsp; $[BD]$ aient le même milieu. On peut donc passer par les coordonnées des milieux.", "Suivant la même idée, on peut aussi dire que &nbsp; $D$ est le symétrique de &nbsp; $B$ par rapport au milieu de &nbsp; $[AC]$. Il faut alors calculer les coordonnées du milieu de &nbsp; $[AC]$ puis faire le calcul de la symétrie.", "La technique la plus efficace reste d'utiliser les vecteurs : on doit avoir &nbsp; $\\overrightarrow{BA} = \\overrightarrow{CD}$. Connaissant le premier, on déduit le second et ensuite la position de &nbsp; $D$."],
